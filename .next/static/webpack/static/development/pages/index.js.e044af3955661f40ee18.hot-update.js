...
function Main_Left_Content() {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://localhost:5000/list').then(function (response) {
    var title = response.data.description; // console.log(response)

    console.log(title); // console.log(title[0])
    // console.log(title[1])
    // console.log(title[2])
    // console.log(title[3])
...
//# sourceMappingURL=index.js.e044af3955661f40ee18.hot-update.js.map