...
function (_React$Component) {
  ...
  _createClass(AllTodo, [{
    ...
    value: function render() {
      ...
      function select_Today_Todo_Id(todos, n) {
        var i = 0;
        var list = [];
      ...
      var a = select_Today_Todo_Id(todos, 1);
      var b = select_Today_Todo_Id(todos, 2);
      var c = a.concat(b);
      console.log(c);
      console.log(select_Today_Todo_Id(todos, 1));
      console.log(select_Today_Todo_Id(todos, 2));
      console.log(select_Today_Todo_Id(todos, 3));
      console.log(select_Today_Todo_Id(todos, 4));
      console.log(select_Today_Todo_Id(todos, 5));
      console.log(select_Today_Todo_Id(todos, 6));
      console.log(select_Today_Todo_Id(todos, 7)); // function sorting(){
      //
      //   var i = 0;
      //   var list = [];
      //   while(i < select_Today_Todo_Id(todos , 1).length){
      //     list.push(select_Today_Todo_Id(todos , 1)[i])
      //     i = i + 1;
      //   }
      //   while(i < select_Today_Todo_Id(todos , 2).length){
      //     list.push(select_Today_Todo_Id(todos , 2)[i])
      //     i = i + 1;
      //   }
      //   while(i < select_Today_Todo_Id(todos , 3).length){
      //     list.push(select_Today_Todo_Id(todos , 3)[i])
      //     i = i + 1;
      //   }
      //   while(i < select_Today_Todo_Id(todos , 4).length){
      //     list.push(select_Today_Todo_Id(todos , 4)[i])
      //     i = i + 1;
      //   }
      //   while(i < select_Today_Todo_Id(todos , 5).length){
      //     list.push(select_Today_Todo_Id(todos , 5)[i])
      //     i = i + 1;
      //   }
      //   while(i < select_Today_Todo_Id(todos , 6).length){
      //     list.push(select_Today_Todo_Id(todos , 6)[i])
      //     i = i + 1;
      //   }
      //   while(i < select_Today_Todo_Id(todos , 7).length){
      //     list.push(select_Today_Todo_Id(todos , 7)[i])
      //     i = i + 1;
      //   }
      //   return list;
      // }
...
//# sourceMappingURL=alltodo.js.f9d6c7dbabc7232f063b.hot-update.js.map