...
function MainContents_Right() {
  ...
  while (i < projects.length) {
    list = list + "<li style=\"list-style-type : none;\"><a style=\"background-color : #f7f7f7; text-decoration : none; font-size : 20px; color : black; padding : 5px; border-radius : 2px;\" class=\"projects\" hover=\"opacity : 0.8;\" href=\"/id=".concat(projects[i], "\">").concat(projects[i], "</a></li><br><br>");
    i = i + 1;
  }
...
//# sourceMappingURL=index.js.1d43ea8689334a357585.hot-update.js.map