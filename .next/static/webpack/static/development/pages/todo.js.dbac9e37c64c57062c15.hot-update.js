...
function (_React$Component) {
  ...
  _createClass(TodayTodo, [{
    ...
    value: function render() {
      ...
      console.log('id list' + selectTodayTodoId(todos));
      console.log(selectTodayTodoId(todos)[0]);
      console.log(selectTodayTodoId(todos)[1]);
      console.log(selectTodayTodoId(todos).length);
      ...
      function maketodo() {
        ...
        while (i < selectTodayTodoId(todos).length) {
          todo.push(todos[selectTodayTodoId(todos)[i]]);
          i = i + 1;
        }
...
//# sourceMappingURL=todo.js.dbac9e37c64c57062c15.hot-update.js.map