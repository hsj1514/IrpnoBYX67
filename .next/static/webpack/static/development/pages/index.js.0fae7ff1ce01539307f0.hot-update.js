  ...
  function UserForm() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSubmit", function (e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('http://localhost:5000/add', {
        ...
        console.log('post 성공'); //access the results here....
      });
    });
  ...
  _createClass(UserForm, [{
    ...
    value: function render() {
      var _this$state2 = this.state,
          ...
          description = _this$state2.description; // console.log(this.state)
...
//# sourceMappingURL=index.js.0fae7ff1ce01539307f0.hot-update.js.map