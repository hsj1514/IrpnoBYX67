...
function (_React$Component) {
  ...
  _createClass(AllTodo, [{
    ...
    value: function render() {
      ...
      function sorting() {
        i = 0;
        var start = select_Today_Todo_Id(todos, 0);

        while (i < 365) {
          start = (_readOnlyError("start"), start.concat(select_Today_Todo_Id(todos, i)));
          i = i + 1;
        }
      ...
      console.log(sorting()); //
      // const a = select_Today_Todo_Id(todos , 1)
      // const b = select_Today_Todo_Id(todos , 2)
      // const c = a.concat(b)
      // console.log(c)
      //
...
//# sourceMappingURL=alltodo.js.75d532073b1a2acf5608.hot-update.js.map