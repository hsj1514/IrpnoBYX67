...
function (_React$Component) {
  ...
  _createClass(Onclick, [{
    ...
    value: function onSubmit(event) {
      ...
      var checkboxState = this.state.checkboxState; //   axios.post('http://localhost:5000/add', { checkboxState })
      // .then((result) => {
      // });
    }
...
//# sourceMappingURL=todaytodo.js.5c859405a34747e592f6.hot-update.js.map